...
const initClient = async (argv) => {
  const { privateKeyFile, certFile } = argv;
...
require("yargs/yargs")(process.argv.slice(2))
  ...
  .option("fields-to-check", {
    ...
    array: true,
    describe:
      "Fields in the SObject type (e.g. Account, Lead, etc.) to check for updates",
  })
  .option("fields-to-check-mode", {
    ...
    default: "any",
    describe:
      "Whether the webhook should react when all the fields to check are updated, or when any of them does",
  })
